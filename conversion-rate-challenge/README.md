...
│                         conversion_rate_challenge and configuration for tools like black
│
...
│
└── conversion_rate_challenge   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes conversion_rate_challenge a Python module
    │
