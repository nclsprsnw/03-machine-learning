...
│                         walmart_store_sales and configuration for tools like black
│
...
│
└── walmart_store_sales   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes walmart_store_sales a Python module
    │
